...
public class TodoService {
    ...
    static {
        ...
        todos.add(new Todo(1, "user", "Learn 1", new Date(), false));
        todos.add(new Todo(2, "user", "Learn 2", new Date(), false));
        todos.add(new Todo(3, "user", "Learn 3", new Date(), false));
    }
